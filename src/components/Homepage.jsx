  ...
  return (
    <>
      <div className="flex flex-col md:flex-row justify-center items-center py-4 md:py-7 bg-amber-300">
        <div className="flex flex-col items-center self-start ms-10 md:self-end md:mb-25 mb-4">
          <div
            className={`w-12 h-12 sm:w-16 sm:h-20 md:w-20 md:h-20 bg-black ${
              turn === "white" ? "" : "border-8 border-red-500"
            }`}
          ></div>
          <p className="pt-2 text-xl sm:text-2xl md:text-2xl">Black</p>
        </div>
        ...
        <div className="flex flex-col items-center self-end me-10 md:self-start md:mt-25 mt-4">
          <div
            className={`w-12 h-12 sm:w-16 sm:h-20 md:w-20 md:h-20 bg-white ${
              turn === "white" ? "border-8 border-red-500" : ""
            }`}
          ></div>
